...
map("c", "<C-k>", "<C-n>", { noremap = false })
map("c", "<C-j>", "<C-p>", { noremap = false })
...
vim.keymap.set("v", "k", "v:count == 0 ? 'gj' : 'j'", { expr = true, silent = true })
vim.keymap.set("v", "j", "v:count == 0 ? 'gk' : 'k'", { expr = true, silent = true })
...
pluginKeys.mapDAP = function()
  ...
  map("n", "<leader>dk", ":lua require'dap'.step_over()<CR>", opt)
  map("n", "<leader>dj", ":lua require'dap'.step_out()<CR>", opt)
...
pluginKeys.mapVimspector = function()
  ...
  --  stepOver, stepOut, stepInto
  map("n", "<leader>dk", "<Plug>VimspectorStepOver", opt)
  map("n", "<leader>dj", "<Plug>VimspectorStepOut", opt)
